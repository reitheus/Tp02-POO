...
public class JogoAtual extends JPanel{
    ...
    public JogoAtual(TelaPrincipal tela,Partida jogo) {
        ...
        for(int i = 0; i < jogo.getTam(); i++){
            ...
            //IFs para centralizar as letras melhor
            if((palavra.charAt(i)) == 'm' || (palavra.charAt(i)) == 'M'){
                digitos.get(i).setBounds((i-1)*30 + 24, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'n' || (palavra.charAt(i)) == 'N'){
                digitos.get(i).setBounds((i-1)*30 + 27, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'a' || (palavra.charAt(i)) == 'A' || (palavra.charAt(i)) == 'á' || (palavra.charAt(i)) == 'ã'){
                digitos.get(i).setBounds((i-1)*30 + 27, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'l' || (palavra.charAt(i)) == 'L'){
                digitos.get(i).setBounds((i-1)*30 + 33, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'i' || (palavra.charAt(i)) == 'I' || (palavra.charAt(i)) == 'í' || (palavra.charAt(i)) == 'ì'){
                digitos.get(i).setBounds((i-1)*30 + 33, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'o' || (palavra.charAt(i)) == 'O' || (palavra.charAt(i)) == 'ô' || (palavra.charAt(i)) == 'õ'){
                digitos.get(i).setBounds((i-1)*30 + 28, alturaYletras, 120, 40);

            }else if((palavra.charAt(i)) == 'd' || (palavra.charAt(i)) == 'D'){
                digitos.get(i).setBounds((i-1)*30 + 28, alturaYletras, 120, 40);

            }else{
                digitos.get(i).setBounds(i*30, alturaYletras, 120, 40);
            }

            digitos.get(i).setVisible(false);
            barras.get(i).setBounds(i*30, 10, 120, 47);
            
        }
        
        //adicionando os digitos da palavra no painel
        JPanel painelPalavra = new JPanel();
        for (JLabel digito : digitos) {
            if(digito.getText() == "m" || digito.getText() == "M"){
                digito.setFont(new Font("Arial", Font.BOLD, 34));
            }else{
                digito.setFont(new Font("Arial", Font.BOLD, 35));
            }
            painelPalavra.add(digito);
        }
        //adicionando as barras no painel
        for (JLabel bar : barras) {
            bar.setFont(new Font("Arial", Font.BOLD, 45));
        ...
        painelPalavra.setBounds(350, 160, 500, 100);
        ...
        texto2.setBounds(120,400,420,50);
